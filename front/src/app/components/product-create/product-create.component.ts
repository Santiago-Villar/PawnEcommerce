...
export class ProductCreateComponent implements OnInit {
  ...
  createProduct(formProduct: any): void {
    ...
    const { name, description, price, brand, category } = formProduct;
    // TODO: add stock to new product data
    const newProductData = { name, description, price, brandId: brand.id, categoryId: category.id, colors: colorIds }
